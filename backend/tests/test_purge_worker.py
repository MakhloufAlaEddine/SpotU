...
class TestPurgeReal:
    ...
    async def test_purge_real_local_file_missing(self):
        ...
        try:
            ...
            row_id = await _insert_pfd_row(
                conn,
                "https://java-spring-guide-1.preview.emergentagent.com/api/uploads/img_nonexistent_file.jpg",
    ...
    async def test_purge_idempotent_double_run(self):
        ...
        try:
            row_id = await _insert_pfd_row(
                conn,
                "https://java-spring-guide-1.preview.emergentagent.com/api/uploads/img_idempotent.jpg",
                scheduled_before_days=35
            )
            row_ids.append(row_id)
    ...
    async def test_purge_attempt_count_incremented(self):
        ...
        try:
            row_id = await _insert_pfd_row(
                conn,
                "https://java-spring-guide-1.preview.emergentagent.com/api/uploads/img_attempt_count.jpg",
                scheduled_before_days=35
            )
            row_ids.append(row_id)
    ...
    async def test_purge_non_eligible_not_touched(self):
        ...
        try:
            row_id = await _insert_pfd_row(
                conn,
                "https://java-spring-guide-1.preview.emergentagent.com/api/uploads/img_fresh.jpg",
