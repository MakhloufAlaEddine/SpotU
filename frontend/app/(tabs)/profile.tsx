...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'flex-start', gap: Spacing.sm, padding: Spacing.md, backgroundColor: Colors.secondary, borderRadius: Radius.xl, marginBottom: Spacing.md },
  ...
  badge: { backgroundColor: Colors.secondary, borderRadius: Radius.full, paddingHorizontal: 8, paddingVertical: 2, borderWidth: 1, borderColor: Colors.border },
  coachBadge: { backgroundColor: '#E8F3FF', borderColor: Colors.accent },
  ...
  addServiceBtn: { backgroundColor: Colors.primaryLight, borderRadius: Radius.full, paddingHorizontal: 12, paddingVertical: 5 },
  addServiceText: { fontSize: 12, fontWeight: '700', color: Colors.primary },
  langRow: { flexDirection: 'row', gap: Spacing.sm },
  langBtn: { flex: 1, paddingVertical: 10, paddingHorizontal: 12, borderRadius: Radius.lg, borderWidth: 1.5, borderColor: Colors.border, alignItems: 'center' },
  ...
  adminBtn: { backgroundColor: '#FFF5E0', borderRadius: Radius.lg, padding: Spacing.md, marginBottom: Spacing.md, alignItems: 'center' },
  ...
  serviceRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.secondary, borderRadius: Radius.md, padding: Spacing.md, marginBottom: Spacing.sm },
  serviceInfo: { flex: 1 },
  ...
  modalCard: { backgroundColor: Colors.background, borderTopLeftRadius: Radius.xl, borderTopRightRadius: Radius.xl, padding: Spacing.xl },
  ...
  textInput: { borderWidth: 1.5, borderColor: Colors.border, borderRadius: Radius.md, padding: Spacing.md, fontSize: 15, color: Colors.foreground },
