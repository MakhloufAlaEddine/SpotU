  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Mes SpotMe</Text>
        <TouchableOpacity onPress={() => router.push('/(tabs)/create' as any)} style={styles.headerBtn} testID="add-spotyou-btn">
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.empty}>
              ...
              <Text style={styles.emptyTitle}>Aucun SpotMe</Text>
              <Text style={styles.emptyText}>Vous n'avez pas encore créé de SpotYou.</Text>
              <TouchableOpacity style={styles.createBtn} onPress={() => router.push('/(tabs)/create' as any)}>
                <Text style={styles.createBtnText}>Créer mon premier SpotMe</Text>
              </TouchableOpacity>
            </View>
          }
        />
