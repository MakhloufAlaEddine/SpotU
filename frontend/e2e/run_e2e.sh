...
echo "URL: ${EXPO_PUBLIC_BACKEND_URL:-https://activity-feed-demo.preview.emergentagent.com}"
echo ""
...
$PYTEST_BIN \
  --browser chromium \
  --headed=false \
  --base-url "${EXPO_PUBLIC_BACKEND_URL:-https://activity-feed-demo.preview.emergentagent.com}" \
  $ARGS \
