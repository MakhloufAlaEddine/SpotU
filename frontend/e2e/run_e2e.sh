...
echo "URL: ${EXPO_PUBLIC_BACKEND_URL:-https://create-service-debug.preview.emergentagent.com}"
echo ""
...
$PYTEST_BIN \
  --browser chromium \
  --headed=false \
  --base-url "${EXPO_PUBLIC_BACKEND_URL:-https://create-service-debug.preview.emergentagent.com}" \
  $ARGS \
