...
echo "URL: ${EXPO_PUBLIC_BACKEND_URL:-https://tags-usage-stats.preview.emergentagent.com}"
echo ""
...
$PYTEST_BIN \
  --browser chromium \
  --headed=false \
  --base-url "${EXPO_PUBLIC_BACKEND_URL:-https://tags-usage-stats.preview.emergentagent.com}" \
  $ARGS \
