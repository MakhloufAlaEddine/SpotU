...
echo "URL: ${EXPO_PUBLIC_BACKEND_URL:-https://moderation-dashboard-3.preview.emergentagent.com}"
echo ""
...
$PYTEST_BIN \
  --browser chromium \
  --headed=false \
  --base-url "${EXPO_PUBLIC_BACKEND_URL:-https://moderation-dashboard-3.preview.emergentagent.com}" \
  $ARGS \
