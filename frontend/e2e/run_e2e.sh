...
echo "URL: ${EXPO_PUBLIC_BACKEND_URL:-https://spotu-capacity-fix.preview.emergentagent.com}"
echo ""
...
$PYTEST_BIN \
  --browser chromium \
  --headed=false \
  --base-url "${EXPO_PUBLIC_BACKEND_URL:-https://spotu-capacity-fix.preview.emergentagent.com}" \
  $ARGS \
