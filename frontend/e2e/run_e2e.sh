...
echo "URL: ${EXPO_PUBLIC_BACKEND_URL:-https://relationship-mgmt-1.preview.emergentagent.com}"
echo ""
...
$PYTEST_BIN \
  --browser chromium \
  --headed=false \
  --base-url "${EXPO_PUBLIC_BACKEND_URL:-https://relationship-mgmt-1.preview.emergentagent.com}" \
  $ARGS \
