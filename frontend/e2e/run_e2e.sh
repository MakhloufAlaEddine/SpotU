...
echo "URL: ${EXPO_PUBLIC_BACKEND_URL:-https://spotu-booking-flow.preview.emergentagent.com}"
echo ""
...
$PYTEST_BIN \
  --browser chromium \
  --headed=false \
  --base-url "${EXPO_PUBLIC_BACKEND_URL:-https://spotu-booking-flow.preview.emergentagent.com}" \
  $ARGS \
