...
const translations: Record<string, Record<Lang, string>> = {
  ...
  noPoints: { fr: 'Aucun tagPoint dans cette zone', en: 'No tagPoints in this area' },
  ...
  tagPoints: { fr: 'TagPoints', en: 'TagPoints' },
  coaches: { fr: 'Coachs', en: 'Coaches' },
  noResults: { fr: 'Aucun résultat', en: 'No results' },
  // Create
  createTagPoint: { fr: 'Créer un TagPoint', en: 'Create TagPoint' },
  tagPointTitle: { fr: 'Titre', en: 'Title' },
  tagPointDesc: { fr: 'Description (optionnel)', en: 'Description (optional)' },
  ...
  myTagPoints: { fr: 'Mes TagPoints', en: 'My TagPoints' },
  ...
  // Admin
  adminTitle: { fr: 'Administration WINEK', en: 'WINEK Administration' },
  stats: { fr: 'Statistiques', en: 'Statistics' },
  totalUsers: { fr: 'Utilisateurs', en: 'Users' },
  totalCoaches: { fr: 'Coachs', en: 'Coaches' },
  totalTagPoints: { fr: 'TagPoints actifs', en: 'Active TagPoints' },
